...
$sTableID = "tbl_lol_metrika_geo_countries";
...
$arrData=CLOLYandexMetrika::GetGeoCountries($arFilter);
//print_r($arrData);
...
$arHeaders[]=
	array(	"id"		=>"name",
		"content"	=>GetMessage("LOL_METRIKA_COUNTRY"),
		"sort"		=>false,
		"default"	=>true,
	);
$arHeaders[]=
...
<table cellpadding="0" cellspacing="0" border="0" class="graph">
	<tr>
		<td>
		<img class="graph" src="<?echo htmlspecialchars("lol_metrika_geo_countries_graph.php?lang=".LANG.
