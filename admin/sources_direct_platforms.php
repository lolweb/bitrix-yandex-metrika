...
$sTableID = "tbl_lol_metrika_sources_direct_platforms";
...
$arHeaders[]=	
	array(	"id"		=>"name_platform",
		"content"	=>GetMessage("LOL_METRIKA_PLATFORM"),
		"sort"		=>false,
		"default"	=>true,
	);			
$arHeaders[]=
...
<table cellpadding="0" cellspacing="0" border="0" class="graph" align="center">
	<tr>
		<td>
		<img class="graph" src="<?echo htmlspecialchars("lol_metrika_sources_direct_platforms_graph.php?lang=".LANG.
